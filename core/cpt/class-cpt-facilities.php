...
class CPT_Facilities_CPT extends RBM_CPT {
	...
	public function staff_metabox_content( $post_id ) {
		...
		rbm_cpts_do_field_textarea( array(
			...
			'wysiwyg' => true,
			'wysiwyg_options' => vibrant_life_get_wysiwyg_options(),
			'default' => '<p>[vibrant_life_row][vibrant_life_column small="small-12" medium="medium-12" large="large-6 large-offset-3"][vibrant_life_staff featured=1 columns="small-12 large-6"][/vibrant_life_column][/vibrant_life_row]</p><p style="text-align: center;">[vibrant_life_button url="' . get_the_permalink( $post_id ) . 'staff/" color="tertiary" hollow="true" class="animate-on-scroll fade-in"]' . __( 'Our Staff', 'cpt-facilities' ) . '[/vibrant_life_button]</p>',
		) );
